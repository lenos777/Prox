...
# VPS ga avtomatik deploy script
set -e

SERVER_IP="45.92.173.33"
SSH_USER="root"

echo "🚀 VPS serverga deploy boshlandi..."
echo "Server: $SERVER_IP"
echo "User: $SSH_USER"
echo ""

# SSH orqali serverga ulanish va barcha buyruqlarni bajarish
...
echo "🌐 Saytingiz manzili: http://45.92.173.33"
echo ""
...
echo "🌐 Saytingiz tayyor: http://45.92.173.33"